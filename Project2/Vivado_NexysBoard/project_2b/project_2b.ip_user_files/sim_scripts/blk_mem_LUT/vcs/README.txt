...
#
# Generated by export_simulation on Sun Feb 05 19:47:45 -0500 2017
#
################################################################################
...
switch to the './blk_mem_LUT.sh' script.

./blk_mem_LUT.sh -reset_run
...
./blk_mem_LUT.sh -noclean_files

For more information on the script, please type './blk_mem_LUT.sh -help'.
