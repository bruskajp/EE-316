...
HD_PWD='C:/Users/ulab/Documents/James Bruska/project_2/project_2.runs/blk_mem_LUT_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_LUT.vds -m64 -mode batch -messageDb vivado.pb -notrace -source blk_mem_LUT.tcl
