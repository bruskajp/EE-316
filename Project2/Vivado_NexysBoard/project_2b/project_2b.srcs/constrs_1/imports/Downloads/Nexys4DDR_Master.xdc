...
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { iCnt_en }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
#set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { iF_B }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
...
#set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS33} [get_ports SDA]
...
set_property -dict {PACKAGE_PIN K1 IOSTANDARD LVCMOS33} [get_ports SDA]
set_property -dict {PACKAGE_PIN F6 IOSTANDARD LVCMOS33} [get_ports SCL]
set_property -dict {PACKAGE_PIN J2 IOSTANDARD LVCMOS33} [get_ports high]
