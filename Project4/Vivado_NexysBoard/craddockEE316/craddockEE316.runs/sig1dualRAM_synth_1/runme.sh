...
HD_PWD='C:/Users/ulab/Desktop/craddockEE316/craddockEE316.runs/sig1dualRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sig1dualRAM.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sig1dualRAM.tcl
