...
#
# Generated by export_simulation on Wed Mar 15 19:17:35 -0400 2017
#
################################################################################
...
switch to the './sig1dualRAM.sh' script.

./sig1dualRAM.sh -reset_run
...
./sig1dualRAM.sh -noclean_files

For more information on the script, please type './sig1dualRAM.sh -help'.
